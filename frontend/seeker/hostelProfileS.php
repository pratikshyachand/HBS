...
<?php
$imgPath = !empty($hostel['image']) ? $hostel['image'] : 'img/default-cover.jpg';
$imgFullPath = '/frontend/hostel_owner/' . $imgPath;

// Debug print
echo $imgFullPath; // this will print the full path as plain text
?>

                <img src="<?='../../frontend/hostel_owner/'. !empty($hostel['image']) ? $hostel['image'] : 'img/default-cover.jpg' ?>" 
